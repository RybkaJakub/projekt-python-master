...
def porovnavani(i):
    """
        Tato funkce porovnává jestli je číslo větší než x
        nebo jestli je menší než x
    """
    if (i > x):
        print("Cislo " + str(i) + " je vetsi nez " + str(x))
    else:
        print("Cislo " + str(i) + " je mensi nez " + str(x))

print(porovnavani.__doc__)
for i in range(0,10):
    porovnavani(i)
